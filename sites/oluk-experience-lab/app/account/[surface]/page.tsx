...
export default function AccountSurfacePage({params}:{params:{surface:string}}){return <CustomerSiteChrome route="account"><main><AccountHub mode={params.surface}/></main></CustomerSiteChrome>}
