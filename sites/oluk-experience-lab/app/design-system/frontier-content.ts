...
export const frontierProducts = [
  ...
  record({slug:"lgd-4033",sku:"LGD4033-10",series:"SARM SERIES",name:"LGD-4033",alias:"Ligandrol",strength:"10 MG",servings:"60 SERVINGS",purity:">99%",price:"£49",family:"Research Chemicals",goal:["Bulking"],summary:"A 10 MG Ligandrol format for building a heavier, mass-focused phase.",researchProfile:"LGD-4033 gives a bulk-focused stack its base: a 10 MG format, a clear 60-serving supply and a natural next step into MK-677 or RAD-140.",guidance:"Choose LGD-4033 when size is the priority, then compare the recovery and intensity options that can take the stack further.",considerations:"Read the full product details before choosing your stack.",related:["mk-677","rad-140"],stack:["mk-677","rad-140"]}),
