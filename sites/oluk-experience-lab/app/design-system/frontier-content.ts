 ...
 */
export type ProductFamily = "Research Chemicals" | "Metabolics";
...
export const frontierProducts = [
  ...
  record({slug:"endurashred",series:"COMPOUND SERIES",name:"ENDURASHRED",alias:"LGD-4033 + MK-2866",strength:"16.5 MG",servings:"90 SERVINGS",purity:">99%",price:"",family:"Research Chemicals",goal:[],summary:"ENDURASHRED is presented as an LGD-4033 and MK-2866 compound in a 16.5 MG, 90-serving format.",researchProfile:"Review the compound identity, labelled strength and serving format together.",guidance:"Compare the labelled format with the rest of the Olympus range before choosing.",considerations:"Read the full product details before choosing.",related:[],stack:[]}),
  record({slug:"halo",sku:"80529-11",series:"PROHORMONE SERIES",name:"HALO",alias:"",strength:"",servings:"",purity:"",price:"",family:"Metabolics",goal:[],summary:"Explore HALO in the Olympus PROHORMONE SERIES.",researchProfile:"Review the available HALO product details in one place.",guidance:"Compare the product details with the rest of the Olympus range before choosing.",considerations:"Read the full product details before choosing.",related:[],stack:[]}),
  record({slug:"mass-gh",sku:"80529-06",series:"COMPOUND SERIES",name:"MASS GH",alias:"",strength:"",servings:"",purity:"",price:"",family:"Research Chemicals",goal:[],summary:"Explore MASS GH in the Olympus COMPOUND SERIES.",researchProfile:"Review the available MASS GH product details in one place.",guidance:"Compare the product details with the rest of the Olympus range before choosing.",considerations:"Read the full product details before choosing.",related:[],stack:[]}),
] as const;
