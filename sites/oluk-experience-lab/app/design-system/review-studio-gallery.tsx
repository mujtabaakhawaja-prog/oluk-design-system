...
export function ReviewStudioGallery({ groupId }: { groupId: string }) {
  ...
  if (groupId === "commerce-decision") return <div className={styles.gallery}><ProductDecisionHero product={mk2866Fixture}/><ProductMediaGallery product={mk2866Fixture}/><PurchasePanel product={mk2866Fixture}/><ProductDetailDisclosure product={mk2866Fixture}/><ProductCommerceCard product={mk2866Fixture} variant="vertical"/><ProductDossier product={mk2866Fixture}/><ProductEvidenceSnapshot product={mk2866Fixture}/><MobileDecisionSummary product={mk2866Fixture}/></div>;
