...
export function ProductNarrative({product}:{product:FrontierProductRecord}){return <><section className={styles.twoCol}><article><span className={styles.eyebrow}>Research profile</span><h2>Understand what makes {product.alias} different.</h2><p>{product.researchProfile}</p></article><article><span className={styles.eyebrow}>Before you choose</span><h2>See the format, focus and fit.</h2><p>{product.guidance}</p><p>{product.considerations}</p></article></section><section className={styles.tabSet}><details open><summary>Product detail</summary><p>{product.summary}</p></details><details><summary>Evidence</summary><EvidenceStatusChip state="verified-evidence"/><p>Open the lab record to see the available batch detail and original report.</p></details><details><summary>Reviews</summary><p>See what customers say about ordering, delivery and the finished product.</p></details></section></>}
