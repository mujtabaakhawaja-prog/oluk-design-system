...
export const CUSTOMER_ROUTES = /** @type {const} */ ([
  ...
  { key: "checkout-payment", path: "/checkout/payment", label: "Payment", heading: "Continue to secure payment.", section: "transaction", authorityClass: "static-transaction-candidate" },
