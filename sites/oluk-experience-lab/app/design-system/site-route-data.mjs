...
export const CUSTOMER_ROUTES = /** @type {const} */ ([
  ...
  { key: "evidence-os", path: "/about/evidence-os", label: "EvidenceOS", heading: "A clearer path from product to proof.", section: "company", authorityClass: "customer-candidate" },
  ...
  { key: "checkout-payment-handoff", path: "/checkout/payment-handoff", label: "Payment handoff", heading: "Continue to secure payment.", section: "transaction", authorityClass: "static-transaction-candidate" },
  { key: "checkout-order-pay", path: "/checkout/order-pay", label: "Order pay", heading: "Complete payment.", section: "transaction", authorityClass: "static-transaction-candidate" },
  ...
  { key: "openlab", path: "/open-lab", label: "Open Lab", heading: "Independent evidence, connected to every product.", section: "openlab", authorityClass: "customer-candidate" },
