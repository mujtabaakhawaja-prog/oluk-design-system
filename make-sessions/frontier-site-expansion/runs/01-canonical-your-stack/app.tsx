  ...
  return (
    <article className="card" data-selected={selected || undefined}>
      ...
      <div className="content">
        <div className="relevanceRow"><ContextChip label="STACK ROLE" value={product.stackRole}/><ContextChip label="BEST FOR" value={product.stackFit}/></div>
  ...
  return (
    <main>
      ...
      <section className="anchor">
        <div><span>YOUR STARTING PRODUCT</span><strong>{data.anchorProduct.name}</strong><div className="anchorChips"><ContextChip label="PRODUCT" value={data.anchorProduct.alias}/><ContextChip label="STRENGTH" value={data.anchorProduct.strength}/><ContextChip label="FORMAT" value={data.anchorProduct.servings}/></div></div>
        <div><small>ADDED TO STACK</small><b>{count}</b></div>
      </section>
      <section className="intro"><span>COMPLETE YOUR STACK</span><h1>{data.heading}</h1><p>{data.introduction}</p></section>
