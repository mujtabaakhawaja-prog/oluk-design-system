...
- Use InventoryStatus as the dedicated StockPill contract: `DEC-STOCK-002` maps in-stock to the restrained governed success pair (`#15803D` / `#ECFDF3`), out-of-stock to error/error-soft, and unavailable to muted/unavailable-soft. Evidence, metrics, selection, links and primary interaction remain cobalt.
